...
when present. glTF cooks also compress optional lightmap UV1. `--max-triangles`
applies bounded meshoptimizer simplification for dense meshes. The amazing-labyrinth checkout
