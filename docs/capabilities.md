...
| Public imported-scene child queries | Tested + Implemented | `src/runtime/render_scene_imported_scene.elisa`, `native/render_scene_imported_scene_abi.inc`, `test/render_scene_animation_submission_native.elisa`, `docs/validation/gltf-node-hierarchies.md`; bounded mesh/camera/light counts, opaque imported-camera activation, and root/child mesh visibility and transform edits preserve generation checks without exposing Wicked entities |
