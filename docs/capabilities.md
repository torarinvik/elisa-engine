...
| Deferred structural world command buffer | Tested | `src/world/commands.elisa`, `test/world_commands.elisa`, `test/world_command_primary.elisa`, `docs/validation/deferred-world-commands.md`; compiler phase-borrow diagnostics and event scheduling remain W03 |
