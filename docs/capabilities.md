...
| Versioned prefab instances with runtime remapping | Tested | `src/world/prefab.elisa`, `src/world/prefab_world.elisa`, `src/world/prefab_persistence.elisa`, `src/world/prefab_scene.elisa`, `test/prefab.elisa`, `test/prefab_world.elisa`, `test/prefab_scene.elisa`, `docs/validation/prefab-instances.md`; durable save-schema integration remains W04 |
