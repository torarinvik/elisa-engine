...
| Generation-checked physics body and shape lifecycle | Tested + Implemented | `src/physics/bodies.elisa`, `test/physics_bodies.elisa`, `native/physics_body_bridge.h`, `scripts/wicked_probe.elisascript`, `docs/validation/physics-bodies.md`; compound cooking and broadphase layers remain P02 |
| Bounded native collision queries | Tested + Implemented | `native/physics_query_bridge.h`, `scripts/wicked_probe.elisascript`, `docs/validation/physics-queries.md`; ray nearest/all-hit, sphere overlap, layer/filter masks, destroyed participants, and stale query tokens are gated; shape casts and contact events remain P03 |
