...
| Native PBR material updates | Tested + Implemented | `native/pbr_material_bridge.h`, `scripts/wicked_probe.elisascript`, `docs/validation/pbr-materials-native.md`; validated base/emissive color, metalness, roughness, base-color texture slot, double-sidedness, shadow flags, foreign handles, and unload are gated |
