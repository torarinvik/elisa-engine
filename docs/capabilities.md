...
| Native worker-to-main world-event handoff | Tested + Implemented | `native/world_event_bridge.h`, `scripts/wicked_probe.elisascript`, `docs/validation/world-events-native.md`; bounded phase-gated delivery and unsubscribe behavior are gated |
