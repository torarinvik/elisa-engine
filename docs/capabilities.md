...
| Wicked/Jolt character movement and shape control | Partial + Implemented | `src/physics/runtime_character_api.inc`, `src/runtime/services_character_api.inc`, `native/physics_character_abi.inc`, `test/physics_character_probe.elisa`; grounding, jump, crouch clearance, moving-platform velocity, fixed-tick cadence, and enabled/disabled collision-layer pairs pass in the SDL3/Metal application smoke; ramps, steps, corners, and the interactive obstacle course remain P05 |
