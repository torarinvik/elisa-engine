...
| Versioned transactional save records | Tested + Implemented | `src/world/save_schema.elisa`, `test/save_schema.elisa`, `scripts/save_journal.py`, `docs/validation/save-schema.md`; journaled atomic replacement and corrupt-journal fallback are gated |
