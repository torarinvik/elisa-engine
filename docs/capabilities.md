...
| Perspective and orthographic camera rays | Tested + Implemented | `src/backend/camera.elisa`, `test/camera.elisa`, `native/camera_bridge.h`, `scripts/wicked_probe.elisascript`, `docs/validation/cameras-viewports.md`; native high-DPI projection creation and resize are gated |
