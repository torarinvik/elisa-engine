...
| Typed world event queue and service phases | Tested | `src/world/events.elisa`, `test/world_events.elisa`, `docs/validation/world-events.md`; `emit_world` rejects despawned or stale-epoch entities before queueing; native callback delivery remains W08 |
