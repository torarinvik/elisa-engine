...
| Context-aware action bindings with dead zones, chords, edge transitions, and disconnect cleanup | Tested | `src/runtime/action_input.elisa`, `test/action_input.elisa`, [action-input validation](validation/action-input.md) |
