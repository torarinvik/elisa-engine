...
| Normalized native glTF scene traversal | Tested + Implemented | `native/asset_import.h`, `scripts/wicked_probe.elisascript`, `docs/validation/gltf-scene-import.md`; cgltf node/primitive/camera/light/skin/animation/morph counts and unsupported-content rejection are gated |
