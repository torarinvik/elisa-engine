...
| Tick-stamped replay divergence diagnostics | Tested + Implemented | `src/runtime/replay.elisa`, `native/replay_trace.h`, `test/replay.elisa`, `docs/validation/replay-diagnostics.md`; bounded little-endian frame encoding, atomic trace replacement, checksum validation, and corruption rejection are gated; subsystem-specific digest production remains W09 |
