...
| ufbx | v0.23.0 at commit `fcc5d6ba444cfd3eb80677dba5e37e493941abe5`; `native/fbx_asset_import.h`, `scripts/test_fbx_import.py` | Bounded metadata and largest-mesh importer; synthetic fixture runs in the Wicked build gate | Adapter | Asset owner; A09 still needs full normalized hierarchy, materials/textures, skin/animation conversion, package output, and Elisa load/render integration. |
