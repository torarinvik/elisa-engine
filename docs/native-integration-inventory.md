...
|---|---|---|---|---|
| WickedEngine | sibling checkout `4eba78554ca473be90a4619496c0f4ed1c7bbe5e`; includes SDL3, Jolt collision/query support, reusable mesh shapes, rotated principal inertia, per-instance center-of-mass offsets, and persistent Jolt shape serialization | `scripts/wicked_probe.elisascript`, `native/wicked_probe.cpp`, `native/render_scene_abi.cpp` | Probe | Native backend owner; F05 still has small process-heap changes and macOS framework allocations across repeated device cycles. |
