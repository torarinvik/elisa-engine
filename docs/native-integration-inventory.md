...
| Recast/Detour | commit `6dc1667f580357e8a2154c28b7867bea7e8ad3a7` | `native/recast_probe.h` | Probe | Navigation owner; N01–N04 add cooked tiles, queries, agents, and replanning. |
| miniaudio | `0.11.22`, SHA-256 `9019743287e443c55e5737a7297f38e5e358561701d6db2d905afb114390c410` | `native/miniaudio_probe.h`, `native/audio_probe.h` | Probe | Audio owner; S01–S03 create one device, streaming, buses, voices, and spatial service. |
...
| zstd | Host/library link plus `native/zstd_probe.h` | Wicked driver and package checks | Probe | Asset owner; A03 makes package format bounded, indexed, and runtime-usable. |
