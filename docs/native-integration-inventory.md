...
|---|---|---|---|---|
| WickedEngine | sibling checkout `c1c93008e5273c6c59e6af6114f8bfaee308b0be`; includes command-list/job-drain fixes, Metal dispatch-data and FAudio releases, Lua application-handle cleanup, and a runtime trail queue independent of debug drawing | `scripts/wicked_probe.elisascript`, `native/wicked_probe.cpp`, `native/render_scene_abi.cpp` | Probe | Native backend owner; F05 still has small process-heap changes and macOS framework allocations across repeated device cycles. |
