...
|---|---|---|---|---|
| WickedEngine | sibling checkout `50568e224f284639e285950013c45b3010bd3114`; includes SDL3, Jolt collision/query support, reusable mesh shapes, rotated principal inertia, and per-instance center-of-mass offsets | `scripts/wicked_probe.elisascript`, `native/wicked_probe.cpp`, `native/render_scene_abi.cpp` | Probe | Native backend owner; F05 still has small process-heap changes and macOS framework allocations across repeated device cycles. |
