...
- `DEVELOPER_DIR=/Library/Developer/CommandLineTools /opt/homebrew/bin/python3 scripts/cook_fbx_asset.py --self-test` passed. It validates the two-slot cooked package and simplifies a planar 128-triangle, two-material grid to 64 triangles while preserving both exact index partitions.
