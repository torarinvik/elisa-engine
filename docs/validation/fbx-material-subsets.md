...
- The FBX cooker self-test also verifies that a fixture with an external texture fails by default and succeeds only with `--ignore-material-textures`, retaining its material names and factors.
