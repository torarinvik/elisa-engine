...
lines: it rejects non-finite or inverted bounds, caps queued commands, submits
depth-tested primitives through Wicked's debug renderer, and clears the queue
...
continues to use the generation-checked physics query bridge.
