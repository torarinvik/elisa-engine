...
- [ ] **A06 · P1 · Production texture pipeline** — After: A03, F08.
  ...
  Progress: `native/texture_format_policy.h` selects RGBA8, BC1, or R16F from queried capability bits and forces normal maps to an RGBA8-safe path; KTX2 parsing, mip/color-space/transcode handling, and memory-budget enforcement remain.
...
- [ ] **R04 · P1 · PBR material workflow** — After: R02, A05, A06.
  ...
  Progress: `native/pbr_material_bridge.h` now validates and applies base/emissive color, metalness, roughness, double-sidedness, and shadow flags through generation-checked Wicked material handles; the native gate covers foreign-handle rejection and unload. Texture slots, authored glTF material upload, transparency policy, and tangent/color reference captures remain.
