...
- [ ] **R04 · P1 · PBR material workflow** — After: R02, A05, A06.
  ...
  Progress: `native/pbr_material_bridge.h` now validates and applies base/emissive color, metalness, roughness, double-sidedness, shadow flags, and a bounded base-color texture slot through generation-checked Wicked material handles; the native gate covers foreign-handle rejection, unload, and a cooked KTX1 resource reaching the authored goal material. Authored glTF material upload, transparency policy, and tangent/color reference captures remain.
