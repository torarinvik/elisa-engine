...
- [ ] **S03 · P1 · Spatial audio and world attachment** — After: S01, W02, P03.
  ...
  Progress: `src/audio/spatial.elisa` now owns bounded entity-keyed source attachment, listener/source velocity, distance and cone gain, occlusion, Doppler ratio, and detach/update validation; `test/audio_spatial.elisa` covers the portable policy. Native voice attachment, transform/event integration, and occlusion query plumbing remain.
