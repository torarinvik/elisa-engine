...
// Adapt a worker checkpoint to bounded package-reader work. Reads and zstd
// output are checked at chunk boundaries, so cancellation waits for at most
// the current IO or decode chunk.
template <typename Result>
