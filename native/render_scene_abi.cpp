...
struct RenderSceneService {
    ...
    int32_t shadow_quality = 1; float sun_shadow_receiver_bias = 0.0f; probe::UpscalerCapabilities upscaler_capabilities{};
...
void reset_unlocked(RenderSceneService& state) {
    ...
    state.shadow_quality = 1; state.sun_shadow_receiver_bias = 0.0f; state.upscaler_capabilities = {};
